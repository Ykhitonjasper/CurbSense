...
public final class WebViewController: UIViewController, WKNavigationDelegate, WKUIDelegate {
    ...
    enum Tuning {
        ...
        /// A page can look ready and only then fall into a spinner. This
    ...
    /// Last JS readiness score (need ≥ Tuning.minimumContentScore).
    ...
    private func setupWebView() {
        ...
        // Top under safe area so the system status bar stays visible.
        // Bottom stays edge-to-edge so fixed tab bars sit flush.
    ...
    /// A page that looked ready can still fall into a spinner afterwards, so
